...
var container = document.querySelector("#container");
  ...
  function displayData(data){
      data.forEach(function(ele){
        ...
        iconOne.innerHTML = `<i class="fa-solid fa-cart-arrow-down"></i>`;
        var anchorTagOne = document.createElement("a");
        anchorTagOne.setAttribute("id","anchorOne");
        anchorTagOne.innerText = "View";
        anchorTagOne.addEventListener("click",function(){
          window.location.href="productpage.html";
        })
        ...
        iconTwo.innerHTML = `<i class="fa-solid fa-list"></i>`;
        var anchorTagTwo = document.createElement("a");
        anchorTagTwo.setAttribute("id","anchorTwo");
        anchorTagTwo.innerText = "More";
        anchorTagTwo.addEventListener("click",function(){
          window.location.href="productpage.html";
        })

        left.append(iconOne,anchorTagOne);
        right.append(iconTwo,anchorTagTwo);
        cell.append(left,right);
        table.append(info,price,cell);
        box.append(image);
        individual.append(box,table);
